...
//		}
		...
		//핸드폰 번호 체크
//		if(str.matches("^01[0-9]-[\\d]{3,4}-[\\d]{4}.*")) {
//			System.out.println("매칭");
//		}else {
//			System.out.println("비매칭");
//		}
...
//		if(str.matches("^[^0-9][a-zA-Z0-9]+@[a-z]{1,}+.[a-z]{1,3}")) {
